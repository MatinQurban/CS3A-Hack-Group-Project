...
// ------------------------------ PLACE HOLDER FOR GETKEY ---------------------------------------
(xx_getKey) // whoever is doing input replace the function with your initials (line 219 and 337)
@xx_getKey_return
D=A
@ge_output_return
M=D
...
(KL_outputArrow)		// output arrow onto the screen
@KL_outputArrowContinue
D=A
@ge_output_return
M=D
...
0;JMP			// jump to ge_output_g to actually draw
...
(output_special_case) // handles special case output if its needed
@sign_return
D=A
@KL_outputArrowReturn
M=D
...
(sign_return)	// called after output_special_case to return or print a sign/character
@ge_currentColumn
M=M+1
@ten_thousands_return
D=A
