/ Role2-Variables
/ decimalValue
/ negFlag Indicates the sign of the number: 1 for negative, 0 for positive.
/ Role3 - Variables
...
// (positive or negative) based on the `negFlag` variable.
// Variables used: `decimalValue`, `negFlag`.
// ================================================
...
(BN_formatSign)
    ...
    D=M
    @BN_positiveSign
    D;JEQ            // If negFlag is 0, jump to positive sign
    @BN_negativeSign
...
(BN_displayHelper)
    ...
    D=M
    @ge_output_+
    D;JEQ            // If sign is '+', display '+'
    @ge_output_-
    0;JMP            // If sign is '-', display '-'
...
//
// unless i am mistaken i believe kevin can replace digit with formattedResult and his function will go through the stored decimal value and output the correct to display
//
